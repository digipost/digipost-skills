...
organisation. Digipost enforces it when the document is accessed at digipost.no/bedrift; which level your own
retrieving system applies is up to you. Defer to the Get Inbox doc for the precise semantics.
