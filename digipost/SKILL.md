...
| Decide whether — and how heavily — to involve the developer in a choice they haven't made, **and proactively surface relevant features they may not know to ask for** (auth / sensitivity level, print fallback + return address, notifications, structured document types, share purpose / duration, retention, deletion — cost/compliance/irreversible calls *and* context-relevant value-adds) | **digipost-decision-helper** |
