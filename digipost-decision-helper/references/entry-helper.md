...
| Business domain / sector | 🟡 | The relevance signal that fires the 🔵 structured-`data-type` choices downstream — a *regnskapsbyrå* implies invoices and reminders, an HR system implies employment documents | Inferred from what they describe; announced. Feeds the data-type choice in [send-post-helper.md](send-post-helper.md) |
