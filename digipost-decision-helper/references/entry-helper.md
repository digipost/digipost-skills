...
| Overarching functionality to be implemented  | 🔴 | Need to know which flows to use (the correct skill(s)) | (Resolved how) Inform about high-level functionality the user has not asked for; asked once; sticky |
