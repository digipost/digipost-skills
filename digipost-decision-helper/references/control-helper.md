...
| `stop_sharing` when done | 🔵 | Good data-minimisation once you have what you need; active requests can also be cancelled | Raised when relevant; accepted or declined |
